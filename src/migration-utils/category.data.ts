...
export const faceAndBodyCategories = {
  'Face & Body': {
    description:
    ...
    Skincare: {
      description:
        'Facial care is something you can cheat with when you are young but when the years catch up you will regret that you did not take care of it better. It is unnecessary because it can be so simple. We at Stayhard offer a number of beautiful products for facial care men that will be at your service both in the short and long term. For example, invest in a white smile with our elegant Marvis toothpastes, reduce bags under the eyes or acne with a product from Recipe For Men or buy a proper face wash and minimize the risk of getting acne in the first place. We at Stayhard offer a solid range of cool facial care products for men - find the perfect products for your face with us.',
    },
    'Hair care': {
      description:
    ...
    'Body care': {
      ...
      Deodorant: {
        ...
        'Shower gel': {
          description:
            'At Stayhard, we have collected shower creams in all possible scents. Soap and water dry out the skin and with a shower cream you care for and moisturize the skin in a good way.',
        },
      },
    },
    'Shaving & beard care': {
      description:
        "Like the hair you have on your head, your beard and mustache are exposed to stress daily. It can be about weather changes, that you pull your fingers through it or that you have dry skin that results in skin flakes accumulating in the beard. A beard and a mustache need to be cared for in the same way as you take care of your facial or other hair care. Therefore, invest in using only the best of products. When it comes to styling your beard, there are also several ways in this category to get the look you are looking for if you have a good beard wax and mustache wax. You will find several high-quality and stable waxes in Stayhard's range - all with a charter that will last all day.",
      ...
      'Beard oil': {
        description:
          'A prickly and dry beard is not fun for anyone, neither for you nor for the one who kisses you. The dry beard can also itch and feel dry all the way to the root. Then a factor is required that can soften it and make it as smooth and comfortable as the hair you have on your head. At Stayhard, you will find several different beard oils from major brands such as Beard Junk, Dapper Dan and Proraso, all developed to give your beard the most regal of treatments. You massage the beard oil into the beard as a last step after you have shaved or washed it. Then let it work wonders. Try on a beard oil for a week and we promise that you will notice a significant difference - you have nothing to lose.',
      },
      'Beard tools': {
        description: '',
      },
